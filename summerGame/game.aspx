...
<body dir="rtl" lang="he">
        ...
        <div>
            ...
            <h2>מטרת המשחק: ליצור רצף של ארבעה עיגולים בצבע שלך בטור, בשורה או באלכסון.</h2>
                ...
                <br />
                <ul>
                    <li>במשחק הראשון השחקן הצהוב מתחיל, ובשאר המשחקים יתחיל המנצח של המשחק הקודם</li>
                    <li> כל שחקן מזיז בתורו את העיגול העליון על ידי המקשים ימינה ושמאלה. כשירצה להוריד את העיגול למקום המתאים ילחץ על אנטר. 
                    </li>
            ...
            <ul>
                ...
                <li> אנטר - כדי להוריד את העיגול במורד הטור הנבחר</li>
                 <li> רווח - כדי להתחיל את המשחק מחדש (אין אפשרות להתחיל משחק חדש באמצע משחק נוכחי אלא רק בסופו)
                     <br />אין אפשרות ללחוץ על מקש הרווח במהלך משחק (אלא רק בסופו שיופיע חלון הדורש זאת)</li>
